...
- [service-worker.md](service-worker.md) — the offline fallback for page loads, what it deliberately doesn't cache, debugging with it installed, the kill switch
